...
import uk.ac.ebi.ddi.service.db.model.intersection.*;
import uk.ac.ebi.ddi.service.db.service.intersection.DatasetStatInfoService;
 ...
 */
public class DDIExpDataProcessService {
    @Autowired
...
//    }
     ...
     * default datatype
     */
    public DDIExpDataProcessService() {
...
//            termInDBService.update(term);
     ...
     * @param dataType omics type of the dataset
     */
    public void calculateIntersections(String dataType) {
